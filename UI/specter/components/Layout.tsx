    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-white p-6 shadow-md">
        ...
        <nav className="space-y-4">
          <Link href="/" passHref>
            <a className="flex items-center space-x-3 px-3 py-2 bg-gray-100 rounded-md">
              <UploadCloud className="w-5 h-5" />
              <span className="font-medium">Upload</span>
            </a>
          </Link>
          <Link href="/runs" passHref>
            <a className="flex items-center space-x-3 px-3 py-2 text-gray-600 hover:bg-gray-100 rounded-md">
              <FileText className="w-5 h-5" />
              <span>Run Status</span>
            </a>
          </Link>
          <Link href="/view-runs" passHref>
            <a className="flex items-center space-x-3 px-3 py-2 text-gray-600 hover:bg-gray-100 rounded-md">
